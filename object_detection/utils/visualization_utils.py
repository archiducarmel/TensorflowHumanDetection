...
def draw_fps_on_image(fps, image_np, width, height):
    cv2.putText(image_np, fps, (width-10, 10),
                cv2.FONT_HERSHEY_COMPLEX, 0.45, (77, 4, 200), 2, bottomLeftOrigin=False)

def draw_date_on_image(fps, image_np, width, height):
    cv2.putText(image_np, fps, (10, 10),
                cv2.FONT_HERSHEY_COMPLEX, 0.45, (77, 4, 200), 2, bottomLeftOrigin=False)
      ...
      if scores is None:
        ...
        if not agnostic_mode:
          if classes[i] in category_index.keys():
            ...
            #print('passe', i)
            #print(class_name)
            table_detection.append(class_name)
